...
public class EncryptUtil {
    ...
    public static byte[] str2Bytes(String value) {
        ...
        try {
            ...
            logger.error("将String转换为byte数组异常" );
        }
     ...
     * @return
     */
    public static byte[] generateStrKey() throws NoSuchAlgorithmException {
        ...
        kgen.init(128); //使用用户提供的password初始化此密钥生成器，使其具有确定的密钥大小128字节长。
    ...
    public static String generateTicket(byte[] sessionKey, String sessionId, byte[] encryptKey) {
        ...
        try {
            ...
            logger.error("返回Base64编码的Ticket异常");
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String s = EncryptUtil.encrypt2Str("abc".getBytes(),EncryptUtil.generateStrKey());
        System.out.println(EncryptUtil.decrypt(s.getBytes(),EncryptUtil.generateStrKey()));
    }
