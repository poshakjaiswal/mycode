...
public class CommentVo  extends Page implements Serializable{
    ...
    public CommentVo(Integer user_id, String nickname, Integer comments_id, Integer product_id, Integer comments_type, Integer praise_num, String content, Integer is_del, String is_praise, String head_portrait_url) {
